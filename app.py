...
DATABASE_URL = os.environ.get("postgresql://neondb_owner:npg_lzUnMGp7xi2C@ep-calm-shadow-a2yk1sch-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require") # L'URL de connexion Neon
if not DATABASE_URL:
